...
<table class="table">
    <thead>
    <th style="width: 12%;"><a href="/series" role="button" class="btn btn-default btn-xs">series</a></th>
    ...
    @foreach($leagues as $league)
        <tr>
            <td><img src="/images/32/{{$league->country_alias}}.png">&nbsp;{{$league->country_alias}}<br><a href="http://www.betexplorer.com/soccer/{{$league->country}}/{{$league->name}}">[be]</a>&nbsp;<a href="http://www.sportstats.com/soccer/{{$league->country}}/{{$league->name}}">[ss]</a></td>
        @foreach($game_types as $game_type)
