...
<table class="table">
    ...
    @foreach($leagues as $league)
        <tr>
            <td><img src="/images/32/{{$league->country_alias}}.png">&nbsp;{{$league->country_alias}}&nbsp;<a href="http://www.sportstats.com/soccer/{{$league->country}}/{{$league->name}}">[ss]</a>&nbsp;<a href="http://www.betexplorer.com/soccer/{{$league->country}}/{{$league->name}}">[be]</a></td>
        @foreach($game_types as $game_type)
